...
const IMAGE_BOOKS = [
...

  {
    ...
    bodyText: [
      ...
      "The comical thing about this book is that the potential sequels to this book just keep writing themselves in real time. This book came out even before OpenAI signed that huge deal with the Department of War to allow use of OpenAI systems and intelligence, right after Anthropic refused to. Sam Altman keeps saying and doing insane things, as do majority of AI tech executives in 2026. But Hao also sprinkles in some seeds of hope: stories about hyperscaled data center resistance and local and environmentally friendlier LLM use. Like Hao, I hope for a future where we are all more informed, resilient, and confident in our togetherness."
    ]
  },
...

  {
    ...
    bodyText: [
      "Another book club read which I was on a little bit of a time crunch to finish before the meeting, but the pages turned themselves and I finished well in time. Yesteryear is one of the more controversial books of 2026 (according to BookTok, which I'm not really on to be honest), and yeah I get it! The tale follows Natalie, who has fully embraced a 'tradwife' lifestyle on a ranch in Idaho. As a content creator, she monetizes videos of cooking meals from scratch, gardening, and homeschooling her children. She receives enormous amounts of love and hate from the internet.",
      "She is in complete control of her world until she randomly wakes up in 1855, not knowing how she got there or where her family went. I found it really interesting that she really valued giving a perception of handling everything herself as a 'tradwife' but secretly wanting and needing the most modern of amenities.",
      "Throughout the book, the reader eventually untangles how Natalie amassed her online right-wing Christian following. One of my dominant thoughts: I felt that the author didn't necessarily give Natalie a chance to have her ideology challenged, or a moment where she got to question her radicalism. Unless I was misreading the moment. I think this would have been fine, but she went to Harvard for undergrad so surely her worldview would have been challenged in some way. She mentions Harvard as an experience where mediocre rich white dudes gather and amass power, which I suppose is also true. Still, I would have appreciated a real inflection moment where she's forced to face and meaningfully confront herself and what she believes.",
      "I also never understood exactly what her theology was based in, other than throwing out random phrases around 'God', 'hell', and 'Jesus Christ'. If she believed so fervently in Christianity, what was a grounding force for her? I don't think it was ever really mentioned what sect she belonged to either, or what kind of church her family belonged to.",
      "Something else kind of related: before the book even came out Anne Hathaway had bought the movie rights to the story and will be starring in it as Natalie. I don't know, something rubs me the wrong way about a movie already being planned for a book the general public doesn't even know is good yet! It feels like the movie and large literary industry are organizing and scheming together on what will rise to the top of our algorithms, and I'm not really sure how it makes me feel. But also, I don't blame anyone for hopping on a story that meets the moment where it is, with all the social media attention tradwife accounts get in 2026."
    ]
  },
